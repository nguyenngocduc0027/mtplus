...
<body class="bg-body-bg">
    ...
    <button class="btn btn-primary p-0 position-fixed z-2 text-center rounded-circle"
        ...
        <a href="{{ app()->getLocale() == 'en' ? url('lang/vi') : url('lang/en') }}">
            <i class="text-white ri-global-line fs-30" data-bs-toggle="tooltip" data-bs-placement="left"
                data-bs-title="Change language"></i></a>
    </button>
