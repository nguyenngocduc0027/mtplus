    ...
    <div class="main-content-container overflow-hidden">
        ...
        <div class="card bg-white rounded-10 border border-white mb-4">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 p-20">
                <form class="table-src-form position-relative m-0" action="{{ route('admin.services.index') }}" method="GET">
                    <input type="text" class="form-control w-350" placeholder="Tìm kiếm dịch vụ..." name="search" value="{{ request('search') }}">
                ...
                <a href="{{ route('admin.services.create') }}" class="text-primary text-decoration-none fs-16">+ Thêm Dịch vụ Mới
                </a>
            </div>
            ...
            <div class="default-table-area mx-minus-1 table-contact-list">
                    ...
                    <table class="table align-middle">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="fw-medium ps-3">Tiêu đề</th>
                        ...
                        <tbody>
                            @forelse ($services as $service)
                                <tr>
                                    <td class="text-body ps-3">{{ $service->title }}</td>
                                    <td class="text-secondary">{{ $service->subtitle }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="4" class="text-center">Không tìm thấy dịch vụ nào.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
                ...
                <div
                    ...
                    <span class="fs-15">Hiển thị {{ $services->firstItem() }} đến {{ $services->lastItem() }} của
                        {{ $services->total() }} mục</span>
