...
<div class="main-content-container overflow-hidden">
    <div class="d-flex justify-content-between align-items-center flex-wrap gap-2 mb-4 mt-1">
        <h3 class="mb-0">Thêm Khu vực Hoạt động Mới</h3>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb align-items-center mb-0 lh-1">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <span class="text-secondary">Thêm Mới</span>
                </li>
            </ol>
        </nav>
    </div>
    ...
    <div class="card bg-white rounded-10 border border-white mb-4">
        <div class="p-20">
            <form action="{{ route('admin.operation_areas.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    {{-- Thông tin Chính --}}
                    <div class="col-md-6">
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('card_1_text') is-invalid @enderror" id="card_1_text" name="card_1_text" value="{{ old('card_1_text') }}">
                            @error('card_1_text')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('card_2_text') is-invalid @enderror" id="card_2_text" name="card_2_text" value="{{ old('card_2_text') }}">
                            @error('card_2_text')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('card_3_text') is-invalid @enderror" id="card_3_text" name="card_3_text" value="{{ old('card_3_text') }}">
                            @error('card_3_text')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="d-flex justify-content-end gap-3 mt-4">
                    ...
                    <button type="submit" class="btn btn-primary">Lưu Lĩnh vực Hoạt động</button>
                </div>
            </form>
        </div>
    </div>
