<form id="section{{ $sectionNumber }}-form" enctype="multipart/form-data">
    ...
    <div class="alert alert-info mb-4">
        <i class="fas fa-info-circle"></i> <strong>Section {{ $sectionNumber }}</strong> - Quản lý nội dung cho phần {{ $sectionNumber }} của trang Areas of Operation
    </div>

    <!-- Image Layout Selection -->
    <div class="form-group mb-4">
        <label class="form-label fw-bold">Vị trí hiển thị ảnh *</label>
    ...
    <div class="row mb-4">
                ...
                <div class="form-control text-center position-relative upload-box-{{ $sectionNumber }}">
                    ...
                    <div id="main-image-preview-container-{{ $sectionNumber }}" style="display: {{ $section->main_image_path ? 'flex' : 'none' }};">
                        <div class="position-relative">
                            ...
                            <button type="button" class="btn btn-danger remove-photo-btn position-absolute" style="top: 10px; right: 10px;" onclick="removeMainImage{{ $sectionNumber }}()" title="Xóa ảnh">
        ...
        <div class="col-lg-6">
            <div class="form-group mb-4 only-file-upload" id="thumbnail-upload-{{ $sectionNumber }}">
                <label class="label fs-16 fw-bold">Ảnh thumbnail</label>
                <div class="form-control text-center position-relative upload-box-{{ $sectionNumber }}">
                    ...
                    <div id="thumbnail-preview-container-{{ $sectionNumber }}" style="display: {{ $section->thumbnail_image_path ? 'flex' : 'none' }};">
                        <div class="position-relative">
                            ...
                            <button type="button" class="btn btn-danger remove-photo-btn position-absolute" style="top: 10px; right: 10px;" onclick="removeThumbnail{{ $sectionNumber }}()" title="Xóa ảnh">
                                <i class="ri-close-line fs-18"></i>
                            </button>
                        </div>
                        <div class="position-absolute bottom-0 start-0 end-0 text-center mb-3">
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane fade show active" id="section{{ $sectionNumber }}-vi-content" role="tabpanel">
            <div class="row">
                ...
                <div class="col-md-12 mb-4">
                    <h6 class="fw-bold">3 Điểm nổi bật (Tiếng Việt)</h6>
                </div>
        ...
        <div class="tab-pane fade" id="section{{ $sectionNumber }}-en-content" role="tabpanel">
            <div class="row">
                <div class="col-md-12 mb-4">
                    <label class="form-label fw-bold">Subtitle (English) *</label>
                ...
                <div class="col-md-12 mb-4">
                    <h6 class="fw-bold">3 Key Highlights (English)</h6>
                </div>

                <div class="col-md-12 mb-3">
                    <label class="form-label">Key Highlight 1</label>
                ...
                <div class="col-md-12 mb-3">
                    <label class="form-label">Key Highlight 2</label>
                ...
                <div class="col-md-12 mb-3">
                    <label class="form-label">Key Highlight 3</label>
