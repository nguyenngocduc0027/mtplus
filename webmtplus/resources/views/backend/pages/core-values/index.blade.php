...
@props(['pageTitle' => 'Quản lý nội dung Giá trị cốt lõi'])
@push('styles')
    <style>
        .language-tabs {
    ...
    <div class="card bg-white border border-white rounded-10 p-20">
        <form id="core-values-form" enctype="multipart/form-data">
            ...
            <div class="alert alert-info mb-4">
                <i class="fas fa-info-circle"></i> <strong>Trang Giá trị cốt lõi</strong> - Quản lý nội dung trang Giá trị cốt lõi của công ty
            </div>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="vi-content" role="tabpanel">
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <label class="form-label fw-bold">Phụ đề mục (Tiếng Việt) *</label>
                        ...
                        <div class="col-md-12 mb-4">
                            <label class="form-label fw-bold">Tiêu đề mục (Tiếng Việt) *</label>
                        ...
                        <div class="col-md-12 mb-4">
                            <h6 class="fw-bold">4 Giá trị cốt lõi (Tiếng Việt)</h6>
                        </div>

                        <!-- Value 1 VI -->
                        <div class="col-md-12 mb-3">
                            <label class="form-label fw-bold">Giá trị 1 - Tiêu đề</label>
                        ...
                        <div class="col-md-12 mb-3">
                            <label class="form-label">Giá trị 1 - Mô tả</label>
                        ...
                        <!-- Value 2 VI -->
                        <div class="col-md-12 mb-3">
                            <label class="form-label fw-bold">Giá trị 2 - Tiêu đề</label>
                        ...
                        <div class="col-md-12 mb-3">
                            <label class="form-label">Giá trị 2 - Mô tả</label>
                        ...
                        <!-- Value 3 VI -->
                        <div class="col-md-12 mb-3">
                            <label class="form-label fw-bold">Giá trị 3 - Tiêu đề</label>
                        ...
                        <div class="col-md-12 mb-3">
                            <label class="form-label">Giá trị 3 - Mô tả</label>
                        ...
                        <!-- Value 4 VI -->
                        <div class="col-md-12 mb-3">
                            <label class="form-label fw-bold">Giá trị 4 - Tiêu đề</label>
                        ...
                        <div class="col-md-12 mb-3">
                            <label class="form-label">Giá trị 4 - Mô tả</label>
                ...
                <div class="tab-pane fade" id="en-content" role="tabpanel">
                    <div class="row">
                        <div class="col-md-12 mb-4">
                            <label class="form-label fw-bold">Section Subtitle (English) *</label>
                        ...
                        <div class="col-md-12 mb-4">
                            <label class="form-label fw-bold">Section Title (English) *</label>
                        ...
                        <div class="col-md-12 mb-4">
                            <h6 class="fw-bold">4 Core Values (English)</h6>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <label class="form-label">Value 4 - Description</label>
            ...
            <h5 class="fw-bold mb-4">Biểu tượng (Icons) cho 4 giá trị</h5>

            <div class="row">
                @for ($i = 1; $i <= 4; $i++)
                    <div class="col-lg-6 mb-4">
                        <div class="form-group only-file-upload" id="icon-{{ $i }}-upload">
                            <label class="label fs-16 fw-bold">Biểu tượng Giá trị {{ $i }}</label>
                            <div class="form-control text-center position-relative upload-box">
                                ...
                                <div id="icon-{{ $i }}-preview-container" class="icon-preview-container" style="display: {{ $coreValuesContent->{'value_' . $i . '_icon'} ? 'flex' : 'none' }};">
                                    <div class="position-relative">
                                        ...
                                        <button type="button" class="btn btn-danger remove-photo-btn position-absolute" style="top: 10px; right: 10px;" onclick="removeIcon({{ $i }})" title="Xóa ảnh">
