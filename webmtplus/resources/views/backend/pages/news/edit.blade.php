...
@props(['pageTitle' => __('admin.news.edit_news')])
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="vi-content" role="tabpanel">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title_vi" class="form-control @error('title_vi') is-invalid @enderror" value="{{ old('title_vi', $news->title_vi) }}" required>
                                    @error('title_vi')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="excerpt_vi" class="form-control @error('excerpt_vi') is-invalid @enderror" rows="3">{{ old('excerpt_vi', $news->excerpt_vi) }}</textarea>
                                    @error('excerpt_vi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="content_vi" id="tyni-vi" class="form-control  @error('content_vi') is-invalid @enderror">{{ old('content_vi', $news->content_vi) }}</textarea>
                                    @error('content_vi')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="tab-pane fade" id="en-content" role="tabpanel">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="excerpt_en" class="form-control @error('excerpt_en') is-invalid @enderror" rows="3">{{ old('excerpt_en', $news->excerpt_en) }}</textarea>
                                    @error('excerpt_en')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="content_en" id="tyni-en" class="form-control @error('content_en') is-invalid @enderror">{{ old('content_en', $news->content_en) }}</textarea>
                                    @error('content_en')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="seo-vi-content" role="tabpanel">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="meta_title_vi" class="form-control" value="{{ old('meta_title_vi', $news->meta_title_vi) }}" maxlength="60">
                                    <small class="text-muted">{{ __('admin.news.meta_title_help') }}</small>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">{{ __('admin.news.meta_description_vi') }}</label>
                                    <textarea name="meta_description_vi" class="form-control" rows="2" maxlength="160">{{ old('meta_description_vi', $news->meta_description_vi) }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="meta_keywords_vi" class="form-control" value="{{ old('meta_keywords_vi', $news->meta_keywords_vi) }}">
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="seo-en-content" role="tabpanel">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="meta_title_en" class="form-control" value="{{ old('meta_title_en', $news->meta_title_en) }}" maxlength="60">
                                    <small class="text-muted">{{ __('admin.news.meta_title_help') }}</small>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">{{ __('admin.news.meta_description_en') }}</label>
                                    <textarea name="meta_description_en" class="form-control" rows="2" maxlength="160">{{ old('meta_description_en', $news->meta_description_en) }}</textarea>
                                    <small class="text-muted">{{ __('admin.news.meta_description_help') }}</small>
                                </div>

                                <div class="mb-3">
                                    <label class="form-label">{{ __('admin.news.meta_keywords_en') }}</label>
                                    <input type="text" name="meta_keywords_en" class="form-control" value="{{ old('meta_keywords_en', $news->meta_keywords_en) }}">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body p-20">
                        <div class="mb-3">
                            ...
                            <select name="status" class="form-select form-control @error('status') is-invalid @enderror" required>
                                <option value="draft" {{ old('status', $news->status) == 'draft' ? 'selected' : '' }}>{{ __('admin.news.status_draft') }}</option>
                                <option value="published" {{ old('status', $news->status) == 'published' ? 'selected' : '' }}>{{ __('admin.news.status_published') }}</option>
                                <option value="scheduled" {{ old('status', $news->status) == 'scheduled' ? 'selected' : '' }}>{{ __('admin.news.status_scheduled') }}</option>
                                <option value="archived" {{ old('status', $news->status) == 'archived' ? 'selected' : '' }}>{{ __('admin.news.status_archived') }}</option>
                            </select>
                            @error('status')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" name="published_at" class="form-control @error('published_at') is-invalid @enderror" value="{{ old('published_at', $news->published_at ? $news->published_at->format('Y-m-d\TH:i') : '') }}">
                            @error('published_at')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="author_name" class="form-control" value="{{ old('author_name', $news->author_name) }}">
                        </div>

                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" name="is_active" id="is_active" value="1" {{ old('is_active', $news->is_active) ? 'checked' : '' }}>
                        ...
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" name="is_featured" id="is_featured" value="1" {{ old('is_featured', $news->is_featured) ? 'checked' : '' }}>
                        ...
                        <div class="form-check mb-2">
                            <input class="form-check-input" type="checkbox" name="is_trending" id="is_trending" value="1" {{ old('is_trending', $news->is_trending) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="checkbox" name="allow_comments" id="allow_comments" value="1" {{ old('allow_comments', $news->allow_comments) ? 'checked' : '' }}>
                ...
                <div class="card bg-white rounded-10 border border-white mb-4">
                    ...
                    <div class="card-body p-20">
                        ...
                        <div class="mb-0">
                            ...
                            @foreach($tags as $tag)
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" name="tags[]" value="{{ $tag->id }}" id="tag_{{ $tag->id }}" {{ in_array($tag->id, old('tags', $news->tags->pluck('id')->toArray())) ? 'checked' : '' }}>
                ...
                <div class="card bg-white rounded-10 border border-white mb-4">
                    ...
                    <div class="card-body p-20">
                        <div class="d-flex justify-content-between mb-2">
                            <span>{{ __('admin.news.views') }}:</span>
                            <strong>{{ $news->view_count }}</strong>
                        </div>
                        <div class="d-flex justify-content-between mb-2">
                            <span>{{ __('admin.news.comments') }}:</span>
                            <strong>{{ $news->comment_count }}</strong>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span>{{ __('admin.news.created_at') }}:</span>
                            <strong>{{ $news->created_at->format('d/m/Y') }}</strong>
                        </div>
                    </div>
                </div>
                ...
                <div class="card bg-white rounded-10 border border-white mb-4">
                    <div class="card-body p-20">
                        <button type="submit" class="btn btn-primary w-100 mb-2">
                            <i class="ri-save-line"></i> {{ __('admin.news.update') }}
                        </button>
