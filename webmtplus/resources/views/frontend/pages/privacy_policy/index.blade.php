...
@section('content')
    ...
    <div class="breadcrumb-area position-relative z-1">
        ...
        <img src="{{ asset('frontend/assets/img/breadcrumb/br-shape-1.png') }}" alt="Shape"
        ...
        <div class="container-fluid px-xxl-5">
            <div class="row">
                <div class="col-md-10 offset-md-1 text-center">
                    <h2 class="section-title style-one fw-black text-title">privacy Policy</h2>
                    <ul class="br-menu list-unstyled">
                        <li><a href="{{ route('home') }}"><img src="{{ asset('frontend/assets/img/icons/home-icon.svg') }}"
                                    alt="Icon">HOME</a></li>
