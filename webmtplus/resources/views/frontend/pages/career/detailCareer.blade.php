            ...
            <div class="col-xl-8 pe-xxl-4">
                <div class="job-desc">
                    <div class="single-img round-10 position-relative">
                        <img src="/frontend/assets/img/career/single-career.jpg" alt="Image" class="round-10">
                    ...
                    <div class="single-job-title position-relative z-1 bg-white round-10">
                        ...
                        <ul class="job-metainfo list-unstyled">
                            <li class="position-relative"><img src="/frontend/assets/img/icons/pin-orange-2.svg"
                                    alt="Icon"><span class="fw-medium text-title me-1">Location:</span>East Verdan</li>
                            <li class="position-relative"><img src="/frontend/assets/img/icons/bag-2.svg"
                                    alt="Icon"><span class="fw-medium text-title me-1">Type:</span> Full-Time</li>
                            <li class="position-relative"><img src="/frontend/assets/img/icons/user-2.svg"
                                    alt="Icon"><span class="fw-medium text-title me-1">Experience:</span>2+ Years</li>
                        </ul>
                    </div>
