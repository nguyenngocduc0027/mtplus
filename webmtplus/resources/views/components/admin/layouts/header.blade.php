                    ...
                    <li class="header-right-item language-item">
                        <div class="dropdown notifications language">
                            <button class="btn btn-secondary border-0 p-0 position-relative" type="button">
                                <a href="{{ app()->getLocale() == 'en' ? url('lang/vi') : url('lang/en') }}"><span
                                        class="material-symbols-outlined" style="font-size: 19px;">translate</span></a>
                            </button>
                        </div>
                    </li>
                                ...
                                <div style="max-height: 300px;" data-simplebar>
                                        ...
                                        <a href="chat.html" class="dropdown-item">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/backend/assets/images/user1.jpg" class="rounded-circle"
                                                        style="width: 44px; height: 44px;" alt="images">
                                                </div>
                                                <div class="flex-grow-1 ms-10">
                                                    <p class="fs-16 fw-medium text-secondary mb-2">Jacob Liwiski <span
                                                            class="fs-14 fw-normal text-body ms-2">35 min ago</span>
                                                    </p>
                                    ...
                                    <div class="notification-menu unseen">
                                        <a href="chat.html" class="dropdown-item">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/backend/assets/images/user2.jpg" class="rounded-circle"
                                                        style="width: 44px; height: 44px;" alt="images">
                                                </div>
                                                <div class="flex-grow-1 ms-10">
                                    ...
                                    <div class="notification-menu">
                                        <a href="chat.html" class="dropdown-item">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0">
                                                    <img src="/backend/assets/images/user3.jpg" class="rounded-circle"
                                                        style="width: 44px; height: 44px;" alt="images">
                                                </div>
                                                <div class="flex-grow-1 ms-10">
                                                    <p class="fs-16 fw-medium text-secondary mb-2">Brad Traversy <span
                                                            class="fs-14 fw-normal text-body ms-2">2 days ago</span>
                                                    </p>
                                                    <span class="fs-14-5 fw-medium d-inline-block"
                            ...
                            <div class="d-xxl-flex align-items-center bg-transparent border-0 text-start p-0 cursor dropdown-toggle"
                                ...
                                <div class="flex-shrink-0 position-relative">
                                    <img class="rounded-circle admin-img-width-for-mobile"
                                        style="width: 40px; height: 40px;" src="/backend/assets/images/admin.png"
                                        alt="admin">
                                    <span
                                ...
                                <ul class="admin-link mb-0 list-unstyled">
                                    ...
                                    <li>
                                        <a href="javascript:void(0)" id="btn-logout"
                                            ...
                                            <span class="ms-2">{{ __('auth.content.logout') ?? 'Logout' }}</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
...
<script>
    document.getElementById('btn-logout')?.addEventListener('click', function () {
        ...
        Swal.fire({
            icon: 'warning',
            title: '{{ __("auth.content.confirm_logout") ?? "Logout?" }}',
            text: '{{ __("auth.content.confirm_logout_text") ?? "" }}',
            showCancelButton: true,
            confirmButtonText: '{{ __("auth.content.logout") ?? "Logout" }}',
            cancelButtonText: '{{ __("auth.content.cancel") ?? "Cancel" }}',
        }).then((result) => {
