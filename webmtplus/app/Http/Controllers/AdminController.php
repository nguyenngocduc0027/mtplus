    ...
    public function updateHomeHero(Request $request)
    {
        ...
        try {
            $validated = $request->validate([
                ...
                'hero_slide_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
                'hero_main_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
            ]);
    ...
    public function updateHomeAbout(Request $request)
    {
        ...
        try {
            $validated = $request->validate([
                ...
                'about_main_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
                'about_thumb_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
            ]);
        } catch (\Illuminate\Validation\ValidationException $e) {
            if ($request->wantsJson() || $request->expectsJson() || $request->ajax()) {
                return response()->json([
    ...
    public function updateHomeServices(Request $request)
    {
        ...
        try {
            $validated = $request->validate([
                ...
                'service_1_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
                ...
                'service_2_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
                ...
                'service_3_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
    ...
    public function updateHomeWhyChoose(Request $request)
    {
        ...
        try {
            $validated = $request->validate([
                ...
                'button_url' => 'nullable|string|max:255',
                'ceo_avatar' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
                ...
                'thumb_image' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
            ]);
        } catch (\Illuminate\Validation\ValidationException $e) {
            if ($request->wantsJson() || $request->expectsJson() || $request->ajax()) {
                return response()->json([
    ...
    public function updateHomeTestimonials(Request $request)
    {
        ...
        try {
            $validated = $request->validate([
                ...
                'testimonial_1_avatar' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
                ...
                'testimonial_2_avatar' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
                ...
                'testimonial_3_avatar' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
                ...
                'testimonial_4_avatar' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
