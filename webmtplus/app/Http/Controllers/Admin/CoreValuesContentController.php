    ...
    public function update(Request $request)
    {
        try {
            $validated = $request->validate([
                ...
                'value_1_icon' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
                ...
                'value_2_icon' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
                ...
                'value_3_icon' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
                ...
                'value_4_icon' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg',
            ]);
